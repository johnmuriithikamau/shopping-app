...
header('location:login.php');
	...
	if(isset($_POST['update']))
	{
		...
		$contactno=$_POST['mpesanumber'];

		$query=mysqli_query($con,"update users set name='$name',contactno='$contactno',mpesanumber='$mpesanumber' where id='".$_SESSION['id']."'");
		if($query)
		{
...
<div class="form-group">
			 ...
			 <input type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" value="<?php echo $row['email'];?>" readonly>
					  ...
					  <label class="info-title" for="Contact No.">Mpesa No. <span>*</span></label>
					    <input type="number" class="form-control unicase-form-control text-input" id="mpesanumber" name="mpesanumber"  value="<?php echo $row['mpesanumber'];?>"  maxlength="10">
