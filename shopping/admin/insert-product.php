...
$sql=mysqli_query($con,"insert into products(category,subCategory,productName,productCompany,stocklevel,productPrice,productDescription,shippingCharge,productAvailability,productImage1,productImage2,productImage3,productPriceBeforeDiscount) values('$category','$subcat','$productname','$productcompany','$stocklevel','$productprice','$productdescription','$productscharge','$productavailability','$productimage1','$productimage2','$productimage3','$productpricebd')");
...
<div class="control-group">
<label class="control-label" for="basicinput">stock level</label>
<div class="controls">
<input type="text"    name="stocklevel"  placeholder="enter sock level" class="span8 tip" required>
</div>
</div>
<div class="control-group">
