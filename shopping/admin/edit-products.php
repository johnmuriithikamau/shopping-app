...
$sql=mysqli_query($con,"update  products set category='$category',subCategory='$subcat',productName='$productname',productCompany='$productcompany',stocklevel='$stocklevel',productPrice='$productprice',productDescription='$productdescription',shippingCharge='$productscharge',productAvailability='$productavailability',productPriceBeforeDiscount='$productpricebd' where id='$pid' ");
...
<div class="controls">
<input type="text"    name="stocklevel"  placeholder="Enter stock level" value="<?php echo htmlentities($row['stocklevel']);?>" class="span8 tip" >
</div>
</div>
<div class="control-group">
