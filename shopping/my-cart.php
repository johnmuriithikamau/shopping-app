...
// code for billing address updation
	if(isset($_POST['update']))
	{
		...
		$query=mysqli_query($con,"update users set billingAddress='$baddress',billingState='$bstate',billingCity='$bcity',billingPincode='$bpincode',mpesaname='$mpesaname',mpesaname='$mpesaname' where id='".$_SESSION['id']."'");
		if($query)
		{
...
// code for Shipping address updation
	if(isset($_POST['shipupdate']))
	{
		...
		$mpesaname=$_POST['mpesaname'];
		$mpesanumber=$_POST['mpesanumber'];
		$query=mysqli_query($con,"update users set shippingAddress='$saddress',shippingState='$sstate',shippingCity='$scity',shippingPincode='$spincode',mpesaname='$mpesaname',mpesaname='$mpesaname' where id='".$_SESSION['id']."'");
		if($query)
		{
 ...
 $pdtid=array();
    $sql = "SELECT * FROM products WHERE id IN(";
			...
			while($row = mysqli_fetch_array($query)){
				...
				$subtotal= $_SESSION['cart'][$row['id']]['quantity']*$row['productPrice']+$row['Delivery Charge'];
				$totalprice += $subtotal;
...
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "Ksh"." ".$row['Delivery Charge']; ?>.00</span></td>
...
<div class="form-group">
 ...
 <div class="form-group">
					  ...
					  <input type="text" class="form-control unicase-form-control text-input" placeholder="Mpesa Name[OPTIONAL]" id="mpesaname" name="mpesaname"  value="<?php echo $row['mpesaname'];?>" >
						<input type="number" class="form-control unicase-form-control text-input" placeholder="mpesa number[OPTIONAL]" id="mpesanumber" name="mpesanumber"  value="<?php echo $row['mpesanumber'];?>" >
...
<div class="form-group">
 ...
 <div class="form-group">
					  ...
					  <input type="text" class="form-control unicase-form-control text-input" placeholder="Mpesa Name[OPTIONALl]" id="mpesaname" name="mpesaname" value="<?php echo $row['mpesaname'];?>" >
						<input type="number" class="form-control unicase-form-control text-input" placeholder="mpesa number[OPTIONAL]" id="mpesanumber" name="mpesanumber"  value="<?php echo $row['mpesanumber'];?>" >
