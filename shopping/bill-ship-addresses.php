...
header('location:.php');
	...
	if(isset($_POST['update']))
	{
		...
		$query=mysqli_query($con,"update users set billingAddress='$baddress',billingState='$bstate',billingCity='$bcity',billingPincode='$bpincode',mpesaname='$mpesaname',mpesanumber='$mpesanumber' where id='".$_SESSION['id']."'");
		if($query)
		{
...
// code for Shipping address updation
	if(isset($_POST['shipupdate']))
	{
		...
		$query=mysqli_query($con,"update users set shippingAddress='$saddress',shippingState='$sstate',shippingCity='$scity',shippingPincode='$spincode',mpesaname='$mpesaname',mpesanumber='$mpesanumber' where id='".$_SESSION['id']."'");
		if($query)
		{
