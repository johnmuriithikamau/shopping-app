...
<h3>D-Groceries</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> we are affiliated in making it easier for purchasing groceries online . we are located at nairobi moi avenue.</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">D-groceries@gmail.com</a></span>
                </div>
            </li>
